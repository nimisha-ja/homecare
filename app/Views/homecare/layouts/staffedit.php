            ...
            <div class="col-xxl-10">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?= site_url('staffs/update/' . $staff['id']) ?>" method="post" enctype="multipart/form-data">
                            <?= csrf_field() ?>
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" step="0.01" name="salary" class="form-control" value="<?= old('salary', $staff['salary']) ?>" required>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">Visa Type</label>
                                    <input type="text" name="visa_type" class="form-control" value="<?= old('visa_type', $staff['visa_type']) ?>" required>
                                </div>
                                <div class="col-md-12 mb-3">
                                    <label class="form-label">Current Address</label>
                                    <textarea name="current_address" class="form-control" rows="2" required><?= old('current_address', $staff['current_address']) ?></textarea>
                                </div>

                                <div class="col-md-12 mb-3">
                                    <label class="form-label">Permanent Address</label>
                                    <textarea name="permanent_address" class="form-control" rows="2" required><?= old('permanent_address', $staff['permanent_address']) ?></textarea>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">Passport Number</label>
                                    <input type="text" name="passport_no" class="form-control" value="<?= old('passport_no', $staff['passport_no']) ?>" required>
                                </div>
                                <!-- File Uploads -->
                                <?php
                                $fileFields = [
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <?php if (!empty($staff[$name])): ?>
                                            <div class="mt-1 text-muted small">
                                                Current file: <?= esc($staff[$name]) ?>
                                                <?php
                                                // Determine the folder name based on the input name
                                                $folderMap = [
                                                    'passport_file' => 'passports',
                                                    'dbs_file' => 'dbs',
                                                    'brp_file' => 'brps',
                                                    'application_form_file' => 'application_forms',
                                                    'checklist_file' => 'checklists',
                                                    'training_certificate_file' => 'training_certificates',
                                                    'reference_1_file' => 'references',
                                                    'reference_2_file' => 'references',
                                                    'passport_photo_file' => 'passport_photos',
                                                    'bank_statement_file' => 'bank_statements',
                                                ];
                                                $folder = $folderMap[$name];
                                                $fileUrl = base_url('uploads/' . $folder . '/' . $staff[$name]);
                                                ?>
                                                |
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="date" name="passport_expiry" class="form-control"
                                        value="<?= old('passport_expiry', $staff['passport_expiry']) ?>" required>
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="date" name="dbs_expiry" class="form-control"
                                        value="<?= old('dbs_expiry', $staff['dbs_expiry']) ?>" >
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="date" name="training_expiry" class="form-control"
                                        value="<?= old('training_expiry', $staff['training_expiry']) ?>" >
                                </div>

                                <div class="col-12 mt-4 text-end">
                                    <button type="submit" class="btn btn-warning">Update Staff</button>
                                    <a href="<?= site_url('staffs') ?>" class="btn btn-secondary">Cancel</a>
                                </div>
